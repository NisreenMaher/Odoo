  ...
  return (
    <>
      <div className="flex sm:flex-row flex-col gap-y-4  ">
        <div className="flex-1 sm:mx-0 mx-auto">
          <a href="#">
            <img className="h-8 w-8" src="./logo.svg" alt="Workflow" />
          </a>
        </div>

        <div className=" sm:justify-end justify-center flex flex-1 fill-current text-primary gap-8">
          <a>
            <svg
              width="16"
              height="16"
      ...
      <div className="flex sm:flex-row flex-col text-gray my-8 pb-8 gap-y-4  text-sm">
        <div className="flex-1 sm:mx-0 mx-auto order-2 sm:order-1 ">
          <span>
            Made by <span className="text-white">Nisreen Maher</span>. All right
            reserved
          </span>
        </div>
        <div className="flex-1 justify-end sm:mx-0 mx-auto order-1 sm:order-2 flex gap-4 ">
          <a className="hover:text-white "> Contact</a>
          <a className="hover:text-white ">About us</a>{" "}
          <a className="hover:text-white ">FAQ's</a> <a>Support</a>
        </div>
      </div>
    </>
  );
